    ...
    <div className={cn("flex flex-col gap-2", className)}>
      <div className="relative overflow-hidden rounded-field border border-border-strong bg-surface">
        <canvas
          ...
          /*
            비율을 캔버스 해상도(900×300)와 맞춘다.

            높이를 고정값으로 두면 좁은 화면에서 가로만 줄어들어, 그린 서명이
            세로로 늘어난 채 계약서에 박힌다. 폰에서 서명받는 것이 기본 경로라
            여기서 어긋나면 대부분의 서명이 일그러진다.
          */
          className="aspect-[3/1] w-full cursor-crosshair touch-none"
        />
